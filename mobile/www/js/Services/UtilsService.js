...
app.factory('UtilsService', function(){
		...
		Util.carServDataFormat = function  (data,methodName) {
			var tmp = JSON.stringify(data);
			var res = "method=" + methodName + "&data=" + encodeURI(tmp);
			return res;
		}
		Util.intToHexString = function(data) {
		 var hexByte = data.toString(16);
		 return hexByte.length > 1 ? hexByte.toUpperCase() : '0' + hexByte.toUpperCase() ;
		};
		/**
